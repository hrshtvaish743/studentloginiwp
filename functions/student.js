    ...
    getMarks : function(req, res, regno) {
      Student.findOne({
          ...
          if (!student) failureResponse(req, res, 'Student not registered!');
            ...
            Marks.find({'regno' : student.regno}, function(err, marksData) {
              if(err) throw err;
    ...
    getMessages : function(req, res, regno) {
      Student.findOne({
          ...
          if (!student) failureResponse(req, res, 'Student not registered!');
            ...
            Message.find({'to' : student.regno}, function(err, messages) {
              if(err) throw err;
    ...
    getAttendance : function(req, res, regno) {
      Student.findOne({
          ...
          if (!student) failureResponse(req, res, 'Student not registered!');
            ...
            Attendance.find({'courseCode' : req.body.course, 'facultyId' : req.body.faculty}, function(err, attendanceData){
              if(err) throw err;
